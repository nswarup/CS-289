"""
Simulation of the intelligent driver model on multiple lanes with switching. There is a single stopped car in the center of the road.
"""
...
class SinglePerturbationCenter(Simulation):
    ...
    def initialize(self):
        ...
        self.cars[0].lane = random.randint(1, LANES - 2)
                ...
                if car.last_switch >= STEPS_BETWEEN_SWITCH:
                    ...
                    if car.lane > 0:
                        ...
                        for other_car in self.cars:
                            if other_car.lane == new_lane and (abs(other_car.pos - car.pos) <= RADIUS_OBSERVED or abs(1000 + other_car.pos - car.pos) <= RADIUS_OBSERVED or abs(other_car.pos - car.pos - 1000) <= RADIUS_OBSERVED):
                                density += 1
                        ...
                        up_vel = average_velocity * LANE_CHANGE_DISCOUNT
                    ...
                    if car.lane < LANES - 1:
                        ...
                        if density:
                            ...
                            average_velocity = DESIRED_VEL * .95
                        # TODO: slow it down if the car changes lanes and make the position reflect that the car would be moving at an angle
                        down_vel = average_velocity * LANE_CHANGE_DISCOUNT
