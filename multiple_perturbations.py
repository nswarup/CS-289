"""
Simulation of the intelligent driver model on multiple lanes with switching. There are multiple stopped cars.
"""
...
class MultiplePerturbations(Simulation):
    ...
    def initialize(self):
        ...
        self.cars[1].vel = 0
        self.cars[1].stopped = True
        self.cars[1].color = (0, 230, 230)

        self.cars[2].vel = 0
        self.cars[2].stopped = True
        self.cars[2].color = (230, 230, 0)

        self.cars[3].vel = 0
        self.cars[3].stopped = True
        self.cars[3].color = (230, 0, 230)
